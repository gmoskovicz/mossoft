...
package org.elasticsearch.plugin.mossoft;
 ...
 * Example of a plugin.
 */
public class NPLplugin extends Plugin implements ActionPlugin {
    private final ExamplePluginConfiguration config;

    public NPLplugin(Settings settings, Path configPath) {
